...
class MetadataApplicationProfileFieldsController < ApplicationController
  ...
  def index
    @metadata_application_profile_fields = MetadataApplicationProfileField.all
  end
  ...
  def new
    @metadata_application_profile_field = MetadataApplicationProfileField.new
  end
  ...
  def create
    no_error = false
    begin
      metadata_application_profile_field = MetadataApplicationProfileField.new(metadata_field_params)
  ...
  private
    ...
    def set_metadata_field
      @metadata_application_profile_field = MetadataApplicationProfileField.find(params[:id])
    end
