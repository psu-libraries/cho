...
RSpec.describe MetadataApplicationProfile::CsvPresenter do
  ...
  describe '#to_csv' do
    ...
    context 'multiple items in list' do
      ...
      let(:csv_field2) { "field2,date,recommended,no_validation,false,no_vocabulary,abc123,My Abc123,abc123_transform\n" }
