  ...
  context 'when filling in all the fields' do
    ...
    it 'creates a new work object without a file' do
      ...
      within('#document') do
        ...
        expect(page).to have_blacklight_label(:member_of_collection_ids_tesim, 'Member of Collection')
        expect(page).to have_blacklight_field(:member_of_collection_ids_tesim, 'Sample Collection')
        expect(page).to have_blacklight_field(:member_of_collection_ids_tesim, archival_collection.id)
